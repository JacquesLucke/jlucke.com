...
![Cutting side pieces 10x timelapse](/src/assets/watercolor_boxes/side_pieces_cut_timelapse_10x.mp4)

Assembling a box can be done in about a minute and requires no extra tools or glue. Although one can reenforce the contacts with glue of cWourse.
...
![Many Filled Boxes](/src/assets/watercolor_boxes/many_filled_boxes.jpg)
