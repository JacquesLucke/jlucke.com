...
Choosing fonts always feels tricky to me. After some reading and looking at other examples, I decided to pair a serif font for text-heavy content with a sans-serif font for headlines and shorter texts. Specifically, I'm using using Source Serif Pro and Lato currently but that may change over time.
