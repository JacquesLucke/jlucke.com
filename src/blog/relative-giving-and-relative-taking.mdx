...
"Network effect" describes the phenomenon by which value of a platform depends on the number of users. A typical example is a chat app. The best chat app in the world is worth nothing if no one uses it.
...
### What kinds of projects should everyone support?
