...
<BlogCollapsibleSection title="Won't this result in much smaller individual donations?">
...
<BlogCollapsibleSection title="How should the platform be called and what should it look like?">
