...
I call this **relative giving** because each project gets an amount relative to you total budget. Additionally, ideally your budget is relative to what you would otherwise save each month.
...
You may wonder why projects would give up some of their income. I think this comes down to building a social expectation around giving which can be encouraged by making every project pay forward some percentage **by default**.
