...
In my neighborhood there is the [MINT Werkstatt](https://biotech-verbund.de/uber-uns/bbb-mint-werkstatt-im-kreativwerk-r6/), a room for children and teens to learn about various STEM topics (science, technology, engineering, mathematics). I'm helping out there occasionally by teaching some coding, Blender, Godot, 3D printing etc.
